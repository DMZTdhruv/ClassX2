...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        'min-w-0 shrink-0 select-none  grow-0 basis-full',
    ...
    <button
      ...
      className={cn(
        ...
        orientation === 'horizontal'
          ...
          : '-top-12 left-1/2 bg-transparent border-none -translate-x-1/2 rotate-90',
      ...
      {...props}
    >
      <FaArrowLeft className='h-4 w-4 bg-transparent' />
